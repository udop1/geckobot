module.exports = {
	...
	async execute(interaction) {
		...
		try {
			...
			if (skipTo >= queue.current.durationMS) {
				return await interaction.editReply({ content: `You can only seek within the duration of the song (\`${queue.current.duration}\`)`, ephemeral: true });
			}
